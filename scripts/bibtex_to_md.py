...
fined_taxonomy = {
    ...
    # 1: resource type
    "Type": ["Survey", "Important", "New Settings or Metrics", "New Few-shot Application",
    ...
    # 6: Setting
    "Setting": ["N-way-K-shot", "Other Setting"],
...
dir_path_fsl4all = ["fsl4all/" + dp for dp in dir_path]
dir_path_fsl4nlp = ["fsl4nlp/" + dp for dp in dir_path]
dir_path_fsl4cv_robot = ["fsl4cv_robot/" + dp for dp in dir_path]
sub_dirs = [dir_path_fsl4nlp, dir_path_fsl4cv_robot, dir_path_fsl4all]
